                ...
                case RECORD_CHECKSUM_NIBBLE_0: //checksum byte 2
                    ...
                    switch(current_record.RecordType)
                    {
                        case RECORD_TYPE_DATA_RECORD:
                            ...
                            {
								BLIO_ReportBootStatus(0, "BL: totalAddress.Val < PROGRAM_FLASH_BASE\r\n" );
								printhex32(totalAddress.Val);
								BLIO_ReportBootStatus(0, "\r\n" );
                            ...
                            {
								BLIO_ReportBootStatus(0, "BL: totalAddress.Val >= MAX_FLASH_ADDRESS\r\n" );
								printhex32(totalAddress.Val);
								BLIO_ReportBootStatus(0, "\r\n" );
							...
							// Give the user some feedback that we are programming

							BLIO_ReportBootStatus(0, "BL: program: ");
							printhex32(totalAddress.Val);
							BLIO_ReportBootStatus(0, "\r\n" );

							UpdateShowBootStatus( SHOW_PROGRAMMING );
