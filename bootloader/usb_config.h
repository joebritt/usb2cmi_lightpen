...
#define _USB_CONFIG_VERSION_DOT   8
...
#define MAX_ALLOWED_CURRENT 500 // 500 mA

#define NUM_TPL_ENTRIES 1
#define USB_MAX_MASS_STORAGE_DEVICES 1
#define USB_NUM_CONTROL_NAKS 20				// was 200?
...
#define USB_HOST_APP_EVENT_HANDLER USB_ThumbDriveEventHandler

#define USBTasks()          ( USBHostTasks(), USBHostMSDTasks() )
